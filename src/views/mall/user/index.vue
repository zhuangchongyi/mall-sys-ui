<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange" style="width: 100%;">
      ...
      <el-table-column label="微信头像" align="center" prop="wxIcon" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="头像" prop="url">
          <el-input v-model="form.url" placeholder="请输入头像" />
        </el-form-item>
        <el-form-item label="手机号" prop="phone">
        ...
        <el-form-item label="余额" prop="price">
          <el-input v-model="form.price" placeholder="请输入余额" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除会员用户编号为"' + userIds + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有会员用户数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
